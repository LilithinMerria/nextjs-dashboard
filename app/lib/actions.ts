...
export async function createInvoice(prevSate: State, formData: FormData) {
  ...
  try {
    ...
    return { message: "Database error: Invoice creation failed!" };
  }
...
export async function updateInvoice(
  ...
  try {
    ...
    return { message: "Database error: Invoice updated failed" };
  }
...
export async function deleteInvoice(id: string) {
  try {
    ...
    return { message: "Database error: Invoice deletion failed!" };
  }
  revalidatePath("/dashboard/invoices");
}
